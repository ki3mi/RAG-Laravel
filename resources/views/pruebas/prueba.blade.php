...
<head>
    ...
    {{-- <link rel="stylesheet" href="css/prueba.min.css" /> --}}
    <!-- Scripts -->
...
<body class="leading-normal tracking-normal text-indigo-400 m-6 bg-cover bg-fixed"
    style="background-image: url('prueba/header.png');">
    <div class="h-full">
        <!--Nav-->
        ...
        <div class="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="mx-auto md:pt-16">
                ...
                <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                    <img src="prueba/App Store.svg" class="h-12 pr-12 transform hover:scale-125 duration-300 ease-in-out" />
                    <img src="prueba/Play Store.svg" class="h-12 transform hover:scale-125 duration-300 ease-in-out" />
                </div>
            </div>
