<div class="p-4">
    ...
    <div class="flex text-gray-600">
        ...
        <input type="text" class="form-input w-full bg-white dark:bg-gray-800 text-gray-800 dark:text-white rounded-lg mx-4" wire:model="buscar" placeholder="Termino de busqueda">
